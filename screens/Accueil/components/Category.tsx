...
const styles = StyleSheet.create({
  category: {
    ...
    minWidth: (width - theme.sizes.inouting * 2.4 - theme.sizes.base) / 2,
    maxWidth: (width - theme.sizes.inouting * 2.4 - theme.sizes.base) / 2,
    maxHeight: (width - theme.sizes.inouting * 2.4 - theme.sizes.base) / 2,
    marginVertical: 10
  }
});
