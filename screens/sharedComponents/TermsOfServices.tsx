...
const TermsOfServices = () => (
  <ScrollView style={{ marginVertical: theme.sizes.padding }}>
    ...
    <Text caption gray height={24} style={{ marginBottom: theme.sizes.base }}>
      3. You understand that Expo uses third-party vendors and hosting partners
    ...
    <Text caption gray height={24} style={{ marginBottom: theme.sizes.base }}>
      ...
      Expo reserves the right at all times to reclaim any Expo subdomain without
      liability to you.
    </Text>
    <Text caption gray height={24} style={{ marginBottom: theme.sizes.base }}>
    ...
    <Text caption gray height={24} style={{ marginBottom: theme.sizes.base }}>
      ...
      retribution) of any Expo customer, employee, member, or officer will
    ...
    <Text caption gray height={24} style={{ marginBottom: theme.sizes.base }}>
      10. You must not upload, post, host, or transmit unsolicited e-mail, SMSs,
      or "spam" messages.
    </Text>
  </ScrollView>
);
